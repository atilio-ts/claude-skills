...
Se debe analizar y revisar si la propuesta para el proyecto es correcta y si la estimación de horas es apropiada.

Definición de hecho
Documento de propuesta corregido en caso de ser necesario y estimación de horas verificada.
```
